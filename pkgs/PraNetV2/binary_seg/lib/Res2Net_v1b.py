...
def res2net50_v1b_26w_4s(pretrained=False, **kwargs):
    ...
    """
    model = Res2Net(Bottle2neck, [3, 4, 6, 3], baseWidth=26, scale=4, **kwargs)
    print(f" we are not loading res2net50_v1b_26w_4s-3cf99910.pth  ")
    pretrained = False
    if pretrained:
        ...
        model_state=torch.load('pkgs/PraNetV2/binary_seg/models/res2net50_v1b_26w_4s-3cf99910.pth', weights_only=True) # 修改
